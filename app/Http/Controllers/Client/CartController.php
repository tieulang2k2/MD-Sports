...
//            return redirect()->back()->with('err', trans('log.err'));
    ...
    public function payment(Request $request)
    {
        ...
        if ($request->payment_method == 3) { // 1-COD, 2-Momo, 3-VNPAY
            ...
            $vnp_TmnCode = "6AXNG9V9"; // Mã website tại VNPAY
            $vnp_HashSecret = "UEKG6MQ9CY1BIZALW2UJGEVMNIT3DT4Q"; // Chuỗi bí mật
            ...
            $vnp_Amount = $request->total_amount * 100; // Số tiền tính bằng VND
            $vnp_Locale = 'vn';
            $vnp_BankCode = ''; // Có thể để trống nếu không chắc chắn về mã ngân hàng
